 ...
 * @author evan.summers
 */
public class AdminExecute implements PostgraHttpxHandler {
    
    private static Logger logger = LoggerFactory.getLogger(AdminExecute.class); 
    ...
    private boolean isAllowed(String sql) {
        sql = sql.toLowerCase();
        return sql.matches("^(create|alter|drop) [^;]*$");
    }
}
